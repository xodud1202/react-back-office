...
const ResumeList = () => {
  ...
  // 검색 폼 값을 목록 조회 파라미터로 반영합니다.
  const handleSearch = useCallback((nextParams: Record<string, FormDataEntryValue>) => {
  ...
  return (
    <>
      ...
      <ResumeSearchForm loading={loading} onSearch={handleSearch} />
