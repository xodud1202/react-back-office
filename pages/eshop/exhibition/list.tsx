...
// 화면 진입 시 상품 검색 레이어에 필요한 공통 코드를 조회합니다.
export const getServerSideProps: GetServerSideProps<ExhibitionListPageProps> = async (
...
const ExhibitionListPage = ({
  ...
  return (
    <>
      ...
      <ExhibitionSearchForm onSearch={handleSearch} />
